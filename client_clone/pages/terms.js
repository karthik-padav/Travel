...
export default function Terms() {
  return (
    <section className="p-10">
      ...
      <p className="mb-4">Welcome to Right Diversion!</p>
      <p className="mb-4">
        These terms and conditions outline the rules and regulations for the use
        of Right Diversion's Website, located at www.rightdiversion.com.
      </p>
      <p className="mb-4">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Right Diversion if you do not agree
      ...
      <h2 className="text-lg text-black">Cookies</h2>
      <p className="mb-4">
        We employ the use of cookies. By accessing Right Diversion, you agreed
        to use cookies in agreement with the Right Diversion's Privacy Policy.{" "}
      </p>
      <p className="mb-4">
      ...
      <h2 className="text-lg text-black">License</h2>
      <p className="mb-4">
        Unless otherwise stated, Right Diversion and/or its licensors own the
        intellectual property rights for all material on Right Diversion. All
        intellectual property rights are reserved. You may access this from
        Right Diversion for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>
      <p className="mb-4">You must not:</p>
      <ul>
        <li>Republish material from Right Diversion</li>
        <li>Sell, rent or sub-license material from Right Diversion</li>
        <li>Reproduce, duplicate or copy material from Right Diversion</li>
        <li>Redistribute content from Right Diversion</li>
      </ul>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        exchange opinions and information in certain areas of the website. Right
        Diversion does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Right Diversion,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Right Diversion
      ...
      <p className="mb-4">
        Right Diversion reserves the right to monitor all Comments and to remove
      ...
      <p className="mb-4">
        You hereby grant Right Diversion a non-exclusive license to use,
        reproduce, edit and authorize others to use, reproduce and edit any of
        your Comments in any and all forms, formats or media.
      </p>
      <h2 className="text-lg text-black">Hyperlinking to our Content</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        the hyperlink compensates the absence of Right Diversion; and (d) the
      ...
      <p className="mb-4">
        ...
        e-mail to Right Diversion. Please include your name, your organization
      ...
      <p className="mb-4">
        No use of Right Diversion's logo or other artwork will be allowed for
        linking absent a trademark license agreement.
      </p>
      <h2 className="text-lg text-black">iFrames</h2>
      <p className="mb-4">
        Without prior approval and written permission, you may not create frames
        around our Webpages that alter in any way the visual presentation or
        appearance of our Website.
      </p>
      <h2 className="text-lg text-black">Content Liability</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg text-black">Reservation of Rights</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg text-black">Removal of links from our website</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg text-black">Disclaimer</h2>
      <p className="mb-4">
