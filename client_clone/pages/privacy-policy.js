...
export default function PrivacyPolicy() {
  return (
    <section className="p-10">
      <h1 className="text-xl text-black">Privacy Policy</h1>
      <span className="mb-4 text-xs">Last updated: July 29, 2023</span>
      <p className="mb-4">
      ...
      <h1 className="text-xl text-black">Interpretation and Definitions</h1>
      <h2 className="text-lg text-black">Interpretation</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg text-black">Definitions</h2>
      ...
      <ul>
        ...
        <li className="list-disc ml-4">
          <p className="mb-4">
            ...
            "Us" or "Our" in this Agreement) refers to Right Diversion.
          </p>
        </li>
        <li className="list-disc ml-4">
          <p className="mb-4">
        ...
        <li className="list-disc ml-4">
          <p className="mb-4">
            <strong>Website</strong> refers to Right Diversion, accessible from{" "}
            <a
              href="www.rightdiversion.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              www.rightdiversion.com
            </a>
          </p>
        </li>
        <li className="list-disc ml-4">
      ...
      <h2 className="text-lg text-black">Types of Data Collected</h2>
      <h3 className="text-md text-black">Personal Data</h3>
      <p className="mb-4">
      ...
      <h3 className="text-md text-black">Usage Data</h3>
      <p className="mb-4">
      ...
      <h3 className="text-md text-black">Tracking Technologies and Cookies</h3>
      <p className="mb-4">
      ...
      <h2 className="text-lg text-black">Use of Your Personal Data</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg text-black">Retention of Your Personal Data</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg text-black">Transfer of Your Personal Data</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg text-black">Delete Your Personal Data</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg text-black">Disclosure of Your Personal Data</h2>
      <h3 className="text-md text-black">Business Transactions</h3>
      <p className="mb-4">
      ...
      <h3 className="text-md text-black">Law enforcement</h3>
      <p className="mb-4">
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3 className="text-md text-black">Other legal requirements</h3>
      <p className="mb-4">
      ...
      <h2 className="text-lg text-black">Security of Your Personal Data</h2>
      <p className="mb-4">
      ...
      <h1 className="text-xl text-black">Children's Privacy</h1>
      <p className="mb-4">
      ...
      <h1 className="text-xl text-black">Links to Other Websites</h1>
      <p className="mb-4">
      ...
      <h1 className="text-xl text-black">Changes to this Privacy Policy</h1>
      <p className="mb-4">
      ...
      <ul>
        <li className="list-disc ml-4">
          ...
          <Link href="/contact" className="-m-1.5 p-1.5 underline">
            www.rightdiversion.com/contact
          </Link>
        </li>
      </ul>
    </section>
